...
import { addPost } from '../redux/action/addPost';
import { setUsersProfile } from '../redux/action/users';
import pn from '../images/avatar.png';
import { Button } from '../components/Button';
import './ProfileTest/ProfileTest.scss';
...
function Profile() {
  ...
  const [toogleFollow, setToogleFollow] = useState(false);
  let history = useParams();
  // console.log(history);
  React.useEffect(() => {
    axios
      .get(
        `https://social-network.samuraijs.com/api/1.0/profile/${history.userId}`
      )
      .then((resp) => {
        dispatch(setUsersProfile(resp.data));
  ...
  const hendlePost = () => {
    if (postText.length > 2 && postTittle.length > 2) {
  ...
  const handleFollowTogle = () => {
    setToogleFollow(!toogleFollow);
  };

  return (
    <div className="Profile_main">
      <h1 className="main_tittle">Profile</h1>
      <div className="wrapper">
        <div className="profile-card js-profile-card">
          <div className="profile-card__img">
            <img src={icon} alt="profile card" />
          </div>

          <div className="profile-card__cnt js-profile-cnt">
            <div className="profile-card__name">{profile.fullName}</div>
            <div className="profile-card__txt">
              Front-end Developer from <strong>Ukraine</strong>
            </div>
            <div className="profile-card-loc">
              ...
              <span className="profile-card-loc__txt">Kiev, Ukrain</span>
            </div>
            ...
            <div className="profile-card-inf">
              ...
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">7</div>
            ...
            <div className="profile-card-ctr">
              ...
              <button
                onClick={handleFollowTogle}
                className={
                  !toogleFollow
                    ? 'profile-card__button button--orange'
                    : 'profile-card__button button--blue'
                }>
                {!toogleFollow ? 'Follow' : 'Unfollow'}
              </button>
            </div>
          </div>
      ...
      <svg className="hidden" hidden="hidden">
        <defs>
      ...
      <div className="profile">
        <div className="status">
          <h1 className="main_tittle">Posts</h1>
        </div>

        <span>
          <div className="flexBlock">
            {/* <h2 className="main_tittle">Создать Пост</h2> */}
            <button
              onClick={hendlePost}
              className="profile-card__button button--blue js-message-btn">
              Добавить
            </button>
            {/* <Button text={'Добавить'} onClick={hendlePost} /> */}
          </div>
